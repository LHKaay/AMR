...
├── rest_api.py         # [Infrastructure] HTTP REST API communication wrapper for the robot (CRUD implementation) -> C: Create, R: Read, U: Update, D: Delete
...
Once running, access the control panel via the local URL displayed in the terminal (e.g., http://127.0.0.1:7860).
